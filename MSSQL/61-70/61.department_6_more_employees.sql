...
select employee_id,emp_name,job_id as designation,department_id from employees where department_id in
(select department_id from employees group by department_id having count(employee_id)>=6)

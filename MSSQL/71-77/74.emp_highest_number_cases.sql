...
insert into employees values
  ...
  select emp_name,(qtr1+qtr2+qtr3+qtr4) "Target achieved in all Qtrs" from employees where (qtr1+qtr2+qtr3+qtr4)=(select max(qtr1+qtr2+qtr3+qtr4) from employees)
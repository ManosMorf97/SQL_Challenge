...
select distinct or1.CUSTOMER_ID as customer_id from orders as or1 inner join orders as or2 
on (or1.CUSTOMER_ID=or2.CUSTOMER_ID and or1.ORDER_DATE>=or2.ORDER_DATE and or1.order_id<>or2.order_id)
where or1.ORDER_DATE-or2.ORDER_DATE<=10
order by or1.CUSTOMER_ID;